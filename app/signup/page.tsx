  ...
  return (
    <>
      ...
      <div className="w-full h-[calc(100vh-8rem)] flex flex-col items-center justify-center p-10">
        ...
        <h1 className="text-3xl text-white mt-10">Sign Up</h1>

        <div className="flex flex-col gap-5 mt-10 w-[400px]">
          ...
          <button className="w-[400px] bg-white text-black py-2 rounded-lg hover:bg-[#4f4f4f] hover:text-white cursor-pointer mt-5">Sign Up</button>
